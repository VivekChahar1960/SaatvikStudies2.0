   ...
   return (
     <div className="contact-us-container reversed-layout">
       <div className="contact-form">
         ...
         <form action="https://formsubmit.co/vivekchahar1960@gmail.com" method="POST">
       ...
       <div className="contact-details">
         ...
         <div className="contact-info">
           ...
           <p className="address"><strong>Address:</strong> 400 , SultanPur Dabas , N-delhi 110039</p>
         </div>
         <div className="contact-info">
           <h3>Contact Information</h3>
           <p className='mail'><strong>Email:</strong><a href="mailto:sss@saatvikstudies.com"> sss@saatvikstudies.com</a></p>
           <p className="phone"><strong>Phone:</strong><a href="tel:9773888338">+91 9773888338 </a>,<a href="tel:8383030389">+91 8383030389</a></p>
         </div>
       </div>
     </div>
   );
